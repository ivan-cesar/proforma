                    ...
                    <div class="p-5">
                        ...
                        <form class="user" method="POST" action="{{route('roles.store')}}">
                            ...
                            <div class="form-group">
                                <input type="text" name="libelle" class="form-control" placeholder="Entrez le role">
                            </div>
                ...
                <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                    ...
                    <tbody>
                        @forelse ($roles as $role)
                          <tr class="odd">
                            <td class="sorting_1">{{$role->libelle}}</td>
                            <td>
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <a href="{{route('roles.edit',$role->id)}}"><i class="fas fa-fw fa-edit"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </td>
